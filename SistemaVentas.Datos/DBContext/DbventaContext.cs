...
public partial class DbventaContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.IdCategoria).HasName("PK__Categori__8A3D240CAB103456");
        ...
        {
            entity.HasKey(e => e.IdDetalleVenta).HasName("PK__DetalleV__BFE2843F7535A06B");
        ...
        {
            entity.HasKey(e => e.IdMenu).HasName("PK__Menu__C26AF48303E5005B");
        ...
        {
            entity.HasKey(e => e.IdMenuRol).HasName("PK__MenuRol__9D6D61A4D9BA6DDD");
        ...
        {
            entity.HasKey(e => e.IdNumeroDocumento).HasName("PK__NumeroDo__471E421A7A92F0D4");
        ...
        {
            entity.HasKey(e => e.IdProducto).HasName("PK__Producto__07F4A13249582E95");
        ...
        {
            entity.HasKey(e => e.IdRol).HasName("PK__Rol__3C872F767D3178D1");
        ...
        {
            entity.HasKey(e => e.IdUsuario).HasName("PK__Usuario__645723A6A384CC08");
        ...
        {
            entity.HasKey(e => e.IdVenta).HasName("PK__Venta__077D56145B73374A");
